...
<head>
    ...
    <title>Sistema de Login Boaszczyk Systems</title>
    <style>
        #caixaCadastro,
        #caixaRecuperarSenha,
        #alerta {
...
<body class="bg-dark">
        ...
        <section class="row mb-5">
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaCadastro">
                ...
                <form action="#" class="p-2" id="formCadastro">
                    ...
                    <div class="form-group">
                        <input type="password" name="senhaUsuário" id="senhaUsuário" class="form-control" placeholder="Digite sua senha" minglength="6" required>
                    </div>
    ...
    <script>
         ...
         * Locale: PT_BR... https://gist.github.com/diegoprates/5047663
         */
